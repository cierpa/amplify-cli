...
import { DirectoryCreationOptions, DirectoryCreationResult } from '../utils/directory-manager';
...
export interface IAuthManager {
  ...
  getAtmosphereAllocation(): Promise<AtmosphereAllocation>;
...
export interface IAppProcessor {
  ...
  initializeAmplifyApp(appName: string, config: AppConfiguration): Promise<InitializationResult>;
